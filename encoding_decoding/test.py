...
def main():
    ...
    if eval_task == 'encoding':
        rrr_result = train_rrr_encoder_with_tune(train_data, num_samples=20)
        cnn_result = train_cnn_encoder_with_tune(train_data, num_samples=20)
    elif eval_task == 'decoding':
        rrr_result = train_rrr_decoder_with_tune(train_data, num_samples=20)
        cnn_result = train_cnn_decoder_with_tune(train_data, num_samples=20)
    else:
        raise ValueError(f"Invalid evaluation task: {eval_task}")
